...
class BasicEnv(gym.Env):
    ...
    def step(self, array):
        ...
        Output:
            ...
            info:
        """
        global frame, action_idx, annotations, inaction, memory_objects_in_table, correct_action, path_labels_pkl, ROBOT_ACTION_DURATIONS, FACTOR_ENERGY_PENALTY,ERROR_PROB
    ...
    def CreationDataset(self):
        ...
        global frame, action_idx, annotations_orig
